...
var datesSql = "select to_char(created_date, 'yyyy-MM-DD') from wind group by to_char(created_date, 'yyyy-MM-DD') order by to_char(created_date, 'yyyy-MM-DD') desc union select to_char(created_date, 'yyyy-MM-DD') from temperatureHumidity group by to_char(created_date, 'yyyy-MM-DD') order by to_char(created_date, 'yyyy-MM-DD') desc";
