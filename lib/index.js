...
var datesSql = "select to_char(created_date, 'yyyy-MM-DD') from wind group by to_char(created_date, 'yyyy-MM-DD') union select to_char(created_date, 'yyyy-MM-DD') from rain group by to_char(created_date, 'yyyy-MM-DD') union select to_char(created_date, 'yyyy-MM-DD') from temperatureHumidity group by to_char(created_date, 'yyyy-MM-DD')";
